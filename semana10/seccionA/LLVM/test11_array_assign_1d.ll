...
entry:
    ...
    store i32 1, ptr %_arr_140549656057616_ptr
    %_arr_140549656054288_ptr = alloca i32
    store i32 2, ptr %_arr_140549656054288_ptr
    ...
    %_arr_140549653672336_ptr = alloca i32
    store i32 5, ptr %_arr_140549653672336_ptr
    ret i32 0
}