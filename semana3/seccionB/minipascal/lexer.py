"""
MiniPascal v2 — Analizador léxico.

Novedades de v2 frente a v1:
  - VAR y CONST, para declarar variables y constantes.
  - Los cuatro nombres de tipo (integer/real/boolean/string) como
    palabras reservadas, todas mapeadas al MISMO token TIPO — no nos
    importa gramaticalmente cuál es, solo el texto exacto que traen.
  - DOSPUNTOS (':') para la anotación de tipo, y ASIGNACION (':=').
"""
